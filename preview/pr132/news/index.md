...
- New
  [`epoxy_use_chunk()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/epoxy_use.md)
  and
  [`epoxy_use_file()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/epoxy_use.md)
  ...
  [`?epoxy_use`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/epoxy_use.md)
...
- Fixed an issue with
  [`epoxy_transform_set()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/epoxy_transform.md)
...
- The development version of epoxy included, for some time, two features
  ...
  - The
    [`epoxy_style()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/epoxy_style.md)
    ...
    e.g. [`epoxy_transform_bold()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/epoxy_transform_one_shot.md)
    or
...
- epoxy’s transformers can now be chained via
  ...
  transform function,
  e.g. [`epoxy_transform_collapse()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/epoxy_transform_one_shot.md)
...
- [`epoxyHTML()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/ui_epoxy_html.md)
  and
  [`renderEpoxyHTML()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/render_epoxy.md)
  were renamed
  [`ui_epoxy_html()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/ui_epoxy_html.md)
  and
...
- Added
  ...
  [`epoxy_transform_get()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/epoxy_transform.md)
...
- Added a new
  [`vignette("inline-reporting")`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/articles/inline-reporting.md)
...
- epoxy’s knitr engines can now be set manually via the newly exported
  ...
  [`use_epoxy_glue_engine()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/use_epoxy_knitr_engines.md)
  ([\#30](https://github.com/gadenbuie/epoxy/issues/30)).

- A new transformer,
  [`epoxy_transform_apply()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/epoxy_transform_one_shot.md),
...
- Added
  [`engine_pick()`](http:/pkg.garrickadenbuie.com/epoxy/preview/pr132/reference/engine_pick.md)
