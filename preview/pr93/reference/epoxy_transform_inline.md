...
[`scales::label_dollar()`](https://scales.r-lib.org/reference/label_dollar.html)
...
- .and:
  ...
  is [`and::and()`](https://and.rossellhayes.com/reference/and.html).

- .or:

  The function to apply to `x` when the template is `{..or x}`. Default
  is [`and::or()`](https://and.rossellhayes.com/reference/and.html).

- .incr:

  The function to apply to `x` when the template is `{..incr x}`.
  Default is [`sort()`](https://rdrr.io/r/base/sort.html).

- .decr:

  The function to apply to `x` when the template is `{..decr x}`.
  Default is `function(x) sort(x, decreasing = TRUE)`.

- .bytes:

  The function to apply to `x` when the template is `{..bytes x}`.
  Default is scales::label_bytes().

- .date:

  The function to apply to `x` when the template is `{..date x}`.
  Default is `function(x) format(x, format = "%F")`.

- .time:

  The function to apply to `x` when the template is `{..time x}`.
  Default is `function(x) format(x, format = "%T")`.

- .datetime:

  The function to apply to `x` when the template is `{..datetime x}`.
  Default is `function(x) format(x, format = "%F %T")`.
...
- .number:
  ...
  The function to apply to `x` when the template is `{..number x}`.
...
- .percent:
  ...
  The function to apply to `x` when the template is `{..percent x}`.
...
- .scientific:
  ...
  Default is scales::label_scientific().

- .uppercase:

  The function to apply to `x` when the template is `{..uppercase x}`.
  Default is [`toupper()`](https://rdrr.io/r/base/chartr.html).

- .lowercase:

  The function to apply to `x` when the template is `{..lowercase x}`.
  Default is [`tolower()`](https://rdrr.io/r/base/chartr.html).

- .titlecase:

  The function to apply to `x` when the template is `{..titlecase x}`.
  Default is
...
- .strong:
  ...
  The function to apply to `x` when the template is `{..strong x}`.
  Default is chosen internally based on the output format.

- .emph:

  The function to apply to `x` when the template is `{..emph x}`.
  Default is chosen internally based on the output format.

- .code:

  The function to apply to `x` when the template is `{..code x}`.
  Default is chosen internally based on the output format.
