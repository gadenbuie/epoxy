...
- language:
  ...
  [`and::and()`](https://and.rossellhayes.com/reference/and.html) or
  [`and::or()`](https://and.rossellhayes.com/reference/and.html) to
  choose the correct and/or phrase and spacing for the `language`. By
  default, will follow the system language. See
  [and::and_languages](https://and.rossellhayes.com/reference/and_languages.html)
