...
### [In R Markdown and Quarto reports](http://pkg.garrickadenbuie.com/epoxy/v1.0.0/articles/epoxy-report.md)
...
### [In R scripts](http://pkg.garrickadenbuie.com/epoxy/v1.0.0/articles/epoxy-script.md)
...
### [In Shiny apps](http://pkg.garrickadenbuie.com/epoxy/v1.0.0/articles/epoxy-shiny.md)
...
### [Get started](http://pkg.garrickadenbuie.com/epoxy/v1.0.0/articles/epoxy.md)

Get up and running with epoxy in reports or Shiny apps.

### [Reference](http://pkg.garrickadenbuie.com/epoxy/v1.0.0/reference/index.md)

Function reference with usage and examples.

### [Articles](http://pkg.garrickadenbuie.com/epoxy/v1.0.0/articles/)
