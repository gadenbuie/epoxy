...
### [In R Markdown and Quarto reports](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/articles/epoxy-report.md)
...
### [In R scripts](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/articles/epoxy-script.md)
...
### [In Shiny apps](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/articles/epoxy-shiny.md)
...
[Get
started](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/articles/epoxy.md)

### Reference

Function reference with usage and examples.

[Reference](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/reference/index.md)

### Articles

Longer posts and tutorials about using epoxy in your reports and apps.

[Articles](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/articles/)
