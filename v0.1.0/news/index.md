...
- The development version of epoxy included, for some time, two features
  ...
  - The
    [`epoxy_style()`](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/reference/epoxy_style.md)
    ...
    e.g. [`epoxy_transform_bold()`](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/reference/epoxy_transform_one_shot.md)
    or
...
- epoxy’s transformers can now be chained via
  ...
  transform function,
  e.g. [`epoxy_transform_collapse()`](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/reference/epoxy_transform_one_shot.md)
...
- Added a new
  [`vignette("inline-reporting")`](http://pkg.garrickadenbuie.com/epoxy/v0.1.0/articles/inline-reporting.md)
