...
[bold](http://pkg.garrickadenbuie.com/epoxy/dev/reference/epoxy_transform_one_shot.md)
and
[collapse](http://pkg.garrickadenbuie.com/epoxy/dev/reference/epoxy_transform_one_shot.md)
...
transformer](http://pkg.garrickadenbuie.com/epoxy/dev/reference/epoxy_transform_inline.md).
