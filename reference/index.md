...
- [`epoxy_transform_wrap()`](http://pkg.garrickadenbuie.com/epoxy/reference/epoxy_transform_one_shot.md)
  [`epoxy_transform_bold()`](http://pkg.garrickadenbuie.com/epoxy/reference/epoxy_transform_one_shot.md)
  [`epoxy_transform_italic()`](http://pkg.garrickadenbuie.com/epoxy/reference/epoxy_transform_one_shot.md)
  [`epoxy_transform_apply()`](http://pkg.garrickadenbuie.com/epoxy/reference/epoxy_transform_one_shot.md)
  [`epoxy_transform_code()`](http://pkg.garrickadenbuie.com/epoxy/reference/epoxy_transform_one_shot.md)
...
- [`render_epoxy()`](http://pkg.garrickadenbuie.com/epoxy/reference/render_epoxy.md)
  ...
  : Render Epoxy Output
- [`run_epoxy_example_app()`](http://pkg.garrickadenbuie.com/epoxy/reference/run_epoxy_example_app.md)
  : Example epoxy Shiny apps

## Mustache-style Templating

Sometimes you need just a little bit more templating power than
[`epoxy()`](http://pkg.garrickadenbuie.com/epoxy/reference/epoxy.md) or
[glue](https://glue.tidyverse.org/) can provide. The [mustache
...
- [`bechdel`](http://pkg.garrickadenbuie.com/epoxy/reference/bechdel.md)
