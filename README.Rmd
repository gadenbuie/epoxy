...
<!-- badges: start -->
[![epoxy status badge](https://gadenbuie.r-universe.dev/badges/epoxy)](https://gadenbuie.r-universe.dev)
<!-- badges: end -->
...
you can include `epoxy:::epoxy_set_knitr_engines(use_glue_engine = TRUE)`
in your document's `setup` chunk.
...
Use the `epoxy_html` block to glue R and HTML together.
...
Similarly, you can also use `epoxy_latex` blocks to glue R and LaTeX together.
By default, expressions in these types of blocks are wrapped in `<` and `>`.
