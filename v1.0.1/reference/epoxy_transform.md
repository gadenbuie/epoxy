...
[`epoxy()`](http:/pkg.garrickadenbuie.com/epoxy/v1.0.1/reference/epoxy.md)
and the HTML and LaTeX variants, use `epoxy_transform_set()`. This
function takes the same values as `epoxy_transform()`, but makes them
the default transformer for any
[`epoxy()`](http:/pkg.garrickadenbuie.com/epoxy/v1.0.1/reference/epoxy.md)
...
[bold](http:/pkg.garrickadenbuie.com/epoxy/v1.0.1/reference/epoxy_transform_one_shot.md)
and
[collapse](http:/pkg.garrickadenbuie.com/epoxy/v1.0.1/reference/epoxy_transform_one_shot.md)
...
transformer](http:/pkg.garrickadenbuie.com/epoxy/v1.0.1/reference/epoxy_transform_inline.md).
