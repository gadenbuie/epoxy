...
A character string of the rendered template based on the `label` chunk.
The results are marked as `"asis"` output so that they are treated as
regular text rather than being displayed as code results.
